...
export default function NextEventCard({ event, rsvpStatus, onRSVP }: NextEventCardProps) {
  ...
  if (!event) {
    return (
      <div className="relative overflow-hidden bg-gradient-to-br from-brand-charcoal via-brand-paper to-brand-charcoal p-4 sm:p-6 rounded-xl2 shadow-card border border-brand-maroon w-full">
        {/* Gradient overlay */}
